...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Monitor AI - LLM Eval & Monitoring" },
      { name: "description", content: "Open-source LLM evaluation and observability dashboard with LLM-as-judge scoring." },
      { name: "author", content: "Monitor AI" },
      { property: "og:title", content: "Monitor AI - LLM Eval & Monitoring" },
      ...
      { name: "twitter:site", content: "@MonitorAI" },
      { name: "twitter:title", content: "Monitor AI - LLM Eval & Monitoring" },
