...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dico Monitor - LLM Eval & Monitoring" },
      { name: "description", content: "Open-source LLM evaluation and observability dashboard with LLM-as-judge scoring." },
      { name: "author", content: "Dico Monitor" },
      { property: "og:title", content: "Dico Monitor - LLM Eval & Monitoring" },
      ...
      { name: "twitter:site", content: "@DicoMonitor" },
      { name: "twitter:title", content: "Dico Monitor - LLM Eval & Monitoring" },
